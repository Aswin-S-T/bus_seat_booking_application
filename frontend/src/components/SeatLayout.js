	...
	return (
		<div>
			<div className="row">
				...
				<div className="col-md-6">
					<div class="text-left mt-2" style={{ display: "inline-block" }}>
						<button class="btn btn-primary mb-2">Available</button>
						<button class="btn btn-success mb-2">Choosen</button>
						<button class="btn btn-danger mb-2">Booked</button>
					</div>
				</div>
			</div>
		</div>
